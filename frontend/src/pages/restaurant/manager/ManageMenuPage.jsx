...
export default function ManageMenuPage() {
    ...
    if (!restaurant) return <Alert severity="info" sx={{ m: 3 }}>No restaurant found. Create one first.</Alert>;
            ...
            <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} fullWidth maxWidth="sm">
                ...
                <DialogContent>
                    <Stack spacing={2} sx={{ mt: 1 }}>
                        ...
                        <TextField label="Price (cents)" name="price_cents" type="number"
                            value={form.price_cents} onChange={handleChange}
                            helperText="e.g. 1499 = $14.99. Leave empty for market price." />
